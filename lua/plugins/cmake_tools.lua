return {{
    ...
    config = function()
        require("cmake-tools").setup {
            ...
            cmake_generate_options = {"-DCMAKE_EXPORT_COMPILE_COMMANDS=YES ",}, -- this will be passed when invoke `CMakeGenerate`
            ...
            cmake_executor = { -- executor to use
                ...
                opts = {
                    terminal = {}
                }, -- terminal executor uses the values in cmake_terminal}, -- the options the executor will get, possible values depend on the executor type. See `default_opts` for possible values.
